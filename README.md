...
This repository contains the code used to analyze the data presented in the manuscript **"Specificity and exon target space of splicing modifying compounds"**. All the analyses presented in this repository are based on the human reference genome (GRCh38) downloaded from ENSEMBL. 
