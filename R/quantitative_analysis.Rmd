...
pl <- quantitativeAnalysis(
    inputDf=agaCounts,
    tstCondition="SHS_Risdiplam-655nM",
    ctlCondition="SHS_DMSO",
    fctVar="exon3End",
    minCount=4,
    ylab="Risdiplam-655nM",
    xlab="DMSO" )

##png("figures/scatterplot_quantan_Risdiplam_655nM.png", height=5, width=6, unit="in", res=300)
print( pl )
##dev.off()
...
##png("figures/scatterplot_quantan_4pos_Risdiplam_655nM.png", height=3.5, width=6, unit="in", res=300)
print( pl )
##dev.off()
...
##png("figures/scatterplot_quantan_4pos_nga_Risdiplam_655nM.png", height=3.5, width=6, unit="in", res=300)
print( pl )
##dev.off()
...
pl <- quantitativeAnalysis(
    inputDf=agaCountsSub,
    tstCondition="HeLa_Risdiplam+U16C7G",
    ctlCondition="HeLa_Risdiplam+U1ag",
    fctVar="intronMut",
    minCount=4,
    ylab=expression("Risdiplam + U1-"*C[6]*G[7]),
    xlab="Risdiplam + U1-canonical" )

##png("figures/scatterplot_quantan_intronmut_Risdiplam.png", height=3.5, width=6, unit="in", res=300)
print( pl )
##dev.off()
